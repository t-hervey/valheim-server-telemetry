...
|---|---|---|---|
| 0 | Record strategy, conventions, and restart points | Complete | Pending current commit |
| 1 | Add solution/test project, package references, internals access, and smoke test | Not started | — |
